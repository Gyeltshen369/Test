...
books_list = []
authors_set = set()  # Use set() to initialize an empty set
books_dict = {}
...
if search_title in books_dict:  # Check if the title is in the dictionary keys
...
if remove_title in books_dict:  # Check if the title is in the dictionary keys
    remove_author = books_dict[remove_title]
    books_list.remove(remove_title)
    authors_set.remove(remove_author)
    del books_dict[remove_title]  # Fix typo: remove_titlr -> remove_title
